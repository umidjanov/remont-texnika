  ...
  return (
    <div className="bg-[#0B1427] text-white p-[30px] flex flex-col gap-[40px] items-center">
      ...
      <div className="flex gap-[50px]">
        <a
          className="cursor-pointer flex flex-col gap-[20px] w-[330px] h-[450px] p-[20px] bg-white text-[#0d133a] rounded-md"
        ...
        <a
          className="cursor-pointer lg:flex hidden flex-col gap-[20px] w-[330px] h-[450px] p-[20px] bg-white text-[#0d133a] rounded-md"
          href="https://wdomain.ru/remont-geko.ru"
        >
          <div className="flex items-center gap-[20px]">
            <div className="flex items-center justify-center w-[60px] h-[60px] bg-[#E7742E] rounded-full text-[40px]">
