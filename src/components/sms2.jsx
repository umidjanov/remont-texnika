  ...
  return (
    <div className="bg-[#0B1427] p-[50px] flex items-center flex-col text-white gap-[30px]">
      ...
      <div className="lg:flex gap-[40px] lg:w-[1000px] lg:items-center">
        ...
        <h1 className="lg:text-[22px] lg:text-start text-center lg:w-[1000px] md:w-[470px] w-[300px] text-[20px]">
          Мы ориентированы на долгосрочное сотрудничество с нашими клиентами и
          работаем по принципу “домашнего доктора” для вашей компьютерной
          техники, поэтому обеспечиваем вас технической поддержкой и
          консультациями по всем вопросам, даже самым мелким.
        </h1>
      </div>
      ...
      <h1 className="flex lg:hidden text-[30px] text-center">
