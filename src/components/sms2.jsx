    ...
    return(
        <div className="bg-[#0B1427] p-[50px] flex items-center flex-col text-white gap-[30px]">
            ...
            <div className="flex gap-[30px] items-center">
                ...
                <img className="flex lg:hidden" src="public/Icon102x96_desktop/Message.png" alt="" />
                <div className="border-[1px] border-[#E7742E] lg:w-[350px] w-[100px]"></div>
            </div>
                <h1 className="flex lg:hidden text-[30px]">получить консультацию</h1> 
        </div>
    )
}
